...
let handler = async (m, { conn, text, usedPrefix, command }) => {
	...
	let dann = await fetch(`https://api.lolhuman.xyz/api/growstocks?apikey=gunturganteng&query=${text}`)
	...
	let thumb = `https://api.lolhuman.xyz/api/gimage?apikey=gunturganteng&query=growtopia%20${text}`
