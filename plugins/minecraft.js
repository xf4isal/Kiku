...
let handler = async (m, { conn, text, usedPrefix, command }) => {
	...
	let dann = await fetch(`https://api.lolhuman.xyz/api/minecraft/${text}?apikey=gunturganteng`)
	...
	let thumb = `https://api.lolhuman.xyz/api/gimage?apikey=gunturganteng&query=${text}`
