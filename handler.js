        ...
        try {
            ...
            try {
                ...
                if (chat) {
                    ...
                    if (!('sWelcome' in chat)) chat.sWelcome = `*-UserName:*\n-*@user*\n*-NamaGroup:*\n-@subject\n*-WaktuMasuk:*\n-${wedt}`
                    if (!('sBye' in chat)) chat.sBye = `*-UserName:*\n-*@user*\n*-NamaGroup:*\n-@subject\n*-WaktuKeluar:*\n-${wedt}`
...
contextInfo: {
externalAdReply: {
title: "❌ Your Access Is Denied!!",
thumbnailUrl: 'https://telegra.ph/file/73e6e627650e42fb7e5f8.jpg',
sourceUrl: sgc,
mediaType: 1,
renderLargerThumbnail: true
}}}, { quoted: m})
    let daftar = 'https://telegra.ph/file/09158514bef1b0ba771cd.jpg'
    let msgg = {
        unreg: `ʜᴇʟʟᴏ @${m.sender.split("@")[0]} sɪʟᴀʜᴋᴀɴ ᴅᴀғᴛᴀʀ ᴋᴇ *ᴅᴀᴛᴀʙᴀsᴇ* ʙᴏᴛ ᴛᴇʀʟᴇʙɪʜ ᴅᴀʜᴜʟᴜ ᴊɪᴋᴀ ɪɴɢɪɴ ᴍᴇɴɢɢᴜɴᴀᴋᴀɴ ғɪᴛᴜʀ ʙᴏᴛ!
