...
/*exports.smsg = (conn, m, hasParent) => {
     ...
     */
     m.reply = async (text, chatId, options) => {
        ...
        conn.reply(chatId ? chatId : m.chat, text, m, { contextInfo: { mentionedJid: conn.parseMention(text), externalAdReply: { title: 'Kikuchanj', body: '2023 © Kemii Lèarning', sourceUrl: 'https://wa.me/12024988527', thumbnail: data }}, options })
    }
    m.name = m.pushName || conn.getName(m.sender)
